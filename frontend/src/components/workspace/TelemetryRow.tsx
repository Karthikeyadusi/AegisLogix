...
export function TelemetryRow({
  ...
  return (
    <div
      ...
      className={cn(
        'p-3 rounded-md border transition-all cursor-pointer select-none outline-none focus-visible:ring-2 focus-visible:ring-zinc-400',
        isActive
    ...
    >
      <div className="flex items-center justify-between gap-2 mb-2">
        <div className="flex items-center gap-2.5">
          <span className="w-5 h-5 rounded bg-zinc-800 border border-zinc-700 flex items-center justify-center text-[10px] font-mono font-bold text-zinc-200">
            {index + 1}
          </span>
      ...
      <div className="flex items-center justify-between text-[11px] font-mono text-zinc-400 pt-1.5 border-t border-zinc-800/80">
        <span className="text-zinc-400 font-medium">BBOX</span>
